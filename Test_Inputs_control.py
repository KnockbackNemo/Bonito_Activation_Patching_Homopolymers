""" Find sections of non-repeating bases and corrupt them to introduce single-base errors.
This creates a data set that can be patched and compared to the homopolymer reads
patched in Run_Patches.py"""
...
output_dir = Path("Intermediate_Data/clean_corrupt_pairs/all/Nonhomopolymer")
output_dir.mkdir(parents=True, exist_ok=True)
if not df.empty:
    df.to_csv(output_dir / f"Negative_Control_results_read_{NUM_READ}.csv", index=False)
